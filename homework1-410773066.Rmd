...
```{r ans13}
as.integer(fromEcon) -> grade1
grade1
grade2 <- grade1*grade
grade2
sum(grade2)/sumEcon ->meanEcon
meanEcon
```
...
head(twTime)
str_sub(hour(twTime))
as.integer(str_sub(hour(twTime))) -> hour(twTime)
hour(twTime) 
nightowl <- hour(twTime) %in% c(1,2,3,4,5,6)
nightowl
```
...
length(nightowl)
as.integer(nightowl)
sum(as.integer(nightowl))
nightowlvoteshare <- sum(as.integer(nightowl))/length(nightowl)
nightowlvoteshare
```
...
pass <- grade >= 60
as.integer(pass)
earnedCredit <- as.integer(pass)*credit
earnedCredit
```
...
head(studentID)
head(schoolYear)
studentID == c("046S6f645")
as.integer(studentID == c("046S6f645"))
semester100 <- schoolYear == 100
as.integer(semester100)
credit100chosenStudent <- credit*as.integer(studentID == c("046S6f645"))*as.integer(semester100)
sum(credit100chosenStudent) -> credit100chosenStudent
...
```{r ans33}
earnedCredit100ChosenStudent <- earnedCredit*as.integer(studentID == c("046S6f645"))*as.integer(semester100)
sum(earnedCredit100ChosenStudent)-> earnedCredit100ChosenStudent
...
```{r ans34}
grade*as.integer(studentID == c("046S6f645"))*as.integer(semester100)*credit -> g
sum(g)/credit100chosenStudent -> gpa100ChosenStudent
gpa100ChosenStudent
```
